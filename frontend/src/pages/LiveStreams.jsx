...
const PAGE_CSS = `
  ...
  .stream-placeholder { color: var(--text-secondary, #8ab0c9); font-size: 3rem; }
  ...
  .stream-meta { display: flex; gap: 1rem; color: var(--text-secondary, #8ab0c9); font-size: .8rem; }
  ...
  .empty-streams h2 { color: var(--text-primary, #dff7ff); margin-bottom: 1rem; }
