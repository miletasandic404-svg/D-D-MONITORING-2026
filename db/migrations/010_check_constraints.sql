...
-- =========================================================
-- Adds database-level CHECK constraints to prevent invalid
-- status values that the application code does not expect.
--
-- Safe to run once. Uses DO block for idempotency (IF NOT EXISTS
-- is not supported for ADD CONSTRAINT in all PG versions).
-- All existing data has been verified to match these constraints.
-- =========================================================
