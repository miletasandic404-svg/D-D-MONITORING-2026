          ...
          create: {
            before: async (user) => {
              return {
                data: {
                  ...user,
                  organization_id: _createUserContext.organizationId || user.organization_id || null,
                  user_type: user.user_type || 'operator',
                  status: _createUserContext.status || user.status || 'invited',
                },
              };
            },
          },
 ...
 */
// Module-level context for passing organizationId to databaseHooks during createUser
let _createUserContext = {
  organizationId: null,
  status: null,
};
...
async function createUser({ email, password, name, organizationId, userType }) {
  ...
  // Set context for databaseHooks to access
  _createUserContext.organizationId = organizationId;
  _createUserContext.status = 'invited';
  ...
  try {
    ...
    _createUserContext.organizationId = null;
    _createUserContext.status = null;
